...
export const ui = {
  en: {
    ...
    'contact.desc': 'Best way to reach me would be my Linkedin.',
  ...
  pl: {
    ...
    'hero.title': 'Michał Gazda',
    'hero.desc': 'Inżynier Oprogramowania',
    ...
    'contact.desc': 'Najlepiej skontaktować się ze mną przez LinkedIn.',
